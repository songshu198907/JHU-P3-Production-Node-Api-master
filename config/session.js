 ...
 */
function getSecret(){
  if(process.env.NODE_ENV === 'production') return process.env.APP_SECRET_KEY_PROD;
  if(process.env.NODE_ENV === 'development') return process.env.APP_SECRET_KEY_DEV;
  return process.env.APP_SECRET_KEY_OTHER;
}
