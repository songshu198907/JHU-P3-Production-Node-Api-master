var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1VideoController'),
...
describe('V1Video Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1video'] = _.cloneDeep(stubs.genericModel);
    values = {"desc":"Mononucleosis inconveniencing","isActive":true,"keywords":"Marchionesses stitch","length":55195.9629305419,"questionGroup":"Refocusses personalities","sortOrder":19623,"sourceVersion":"Traverses questionable","targetNumber":86243,"title":"Heterosexuality gawkily","topicId":89732,"videoUrl":"Respectability monopolizing"};
