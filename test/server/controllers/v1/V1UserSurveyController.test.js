var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1UserSurveyController'),
...
describe('V1UserSurvey Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1usersurvey'] = _.cloneDeep(stubs.genericModel);
    values = {"completedAt":"Nationalization particularizes","completition":33958,"createdAt":"2014-02-27 16:02:18 +0000","currentuseranswers":[1,2,3],"firstQuestion":{"one":1,"two":2,"three":3},"firstQuestionId":30982,"firstReminder":true,"isComplete":true,"matchedVideos":[1,2,3],"maternalVideoComplete":true,"maternalVideoNumber":17106,"maternalVideoPosition":16845.534184541528,"pediatricVideoComplete":true,"pediatricVideoNumber":13891,"pediatricVideoPosition":51958.459539414966,"questionCount":22644,"secondReminder":true,"surveyId":11007,"userId":23182,"videoSourceVersion":"Indoctrinating circumvent"};
