var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SendGridController'),
...
describe('V1SendGrid Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1sendgrid'] = _.cloneDeep(stubs.genericModel);
    values = {"id":8357};
