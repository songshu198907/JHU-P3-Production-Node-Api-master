var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1QuestionCodeController'),
...
describe('V1QuestionCode Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1questioncode'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Kenneth Johnston"};
