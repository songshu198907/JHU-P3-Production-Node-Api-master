var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1JobAuditLoggingController'),
...
describe('V1JobAuditLogging Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1jobauditlogging'] = _.cloneDeep(stubs.genericModel);
    values = {"createdAt":"2015-02-09 17:30:52 +0000","name":"Houston Bruen","rowsEffected":"Thunderclouds squalls"};
