var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SettingController'),
...
describe('V1Setting Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1setting'] = _.cloneDeep(stubs.genericModel);
    values = {"awsHealthcareContentBucketName":"Connotations scalds","awsVideoBucketName":"Gastronomic honeymooners","contactUserRegistrationEmailText":"Anachronistic pavements","contactUserRegistrationSubject":"Announces Hymen","forgotPasswordEmailText":"Felicity accessibly","forgotPasswordSubject":"Individualistic manipulating","fromEmail":"Associative cultivated","smsPhoneNumber":"Pillow prohibiting","surveyCompletionEmailSubject":"Alnitak breadbasket","surveyCompletionEmailText":"Pantomimed unconsciousness","surveyNotificationEmailText":"Scorpions stranger","surveyNotificationFinalSmsText":"Plodder jumpsuit","surveyNotificationFirstReminderEmailText":"Vitalizes clubhouses","surveyNotificationFirstReminderSubject":"Convergence excommunicating","surveyNotificationSubject":"Daytime guitarists","termsAndConditions":"Callously unobstructed"};
