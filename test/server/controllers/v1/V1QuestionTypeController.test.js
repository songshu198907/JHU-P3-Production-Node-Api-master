var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1QuestionTypeController'),
...
describe('V1QuestionType Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1questiontype'] = _.cloneDeep(stubs.genericModel);
    values = {"controlType":"Consciousnesses demographically","name":"Shayne Shields"};
