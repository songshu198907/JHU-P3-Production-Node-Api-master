var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1ClinicianBlockRandomizerController'),
...
describe('V1ClinicianBlockRandomizer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1clinicianblockrandomizer'] = _.cloneDeep(stubs.genericModel);
    values = {"id":14509,"clinicianCodeId":55200,"interventionGroup":"Scampering naturalization","patientType":"Plenipotentiary Srivijaya"};
