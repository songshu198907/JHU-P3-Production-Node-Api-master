var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SearchAuditLoggingController'),
...
describe('V1SearchAuditLogging Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1searchauditlogging'] = _.cloneDeep(stubs.genericModel);
    values = {"createdAt":"1994-03-22 21:12:18 +0000","searchTerm":"Doing gripes","userId":69120};
