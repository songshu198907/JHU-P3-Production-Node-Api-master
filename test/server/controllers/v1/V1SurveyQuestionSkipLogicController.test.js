var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SurveyQuestionSkipLogicController'),
...
describe('V1SurveyQuestionSkipLogic Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1surveyquestionskiplogic'] = _.cloneDeep(stubs.genericModel);
    values = {"skipQuestionCodes":"Trustworthy traditionalist","surveyAnswerId":"Carpetbagger rehabilitates"};
