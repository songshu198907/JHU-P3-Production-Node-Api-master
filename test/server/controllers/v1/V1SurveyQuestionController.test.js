var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SurveyQuestionController'),
...
describe('V1SurveyQuestion Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1surveyquestion'] = _.cloneDeep(stubs.genericModel);
    values = {"didYouKnowText":"Perpetuals unmercifully","label":"Zachery tarantula","questionCategoryId":87985,"questionCodeId":30039,"questionGroup":"Falklands impersonates","questionText":"Vaccinates outrageous","questionTypeId":13553,"requiredAnswer":true,"sortOrder":90258,"surveyId":22291};
