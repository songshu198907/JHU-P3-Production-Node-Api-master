var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1QuestionCategoryController'),
...
describe('V1QuestionCategory Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1questioncategory'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Bart Rau"};
