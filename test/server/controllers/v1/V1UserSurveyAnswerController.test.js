var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1UserSurveyAnswerController'),
...
describe('V1UserSurveyAnswer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1usersurveyanswer'] = _.cloneDeep(stubs.genericModel);
    values = {"appliedSkipLogicId":22081,"freeFormResponse":"Disenfranchised Freud","nextquestion":{"one":1,"two":2,"three":3},"previousquestion":{"one":1,"two":2,"three":3},"questionCodeId":90659,"questionGroup":"Photojournalist atrium","questionOrder":45401,"skipped":true,"surveyAnswerId":64470,"surveyQuestionId":89680,"userSurveyId":18320};
