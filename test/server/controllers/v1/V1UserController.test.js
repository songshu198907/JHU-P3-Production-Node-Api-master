var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1UserController'),
...
describe('V1User Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1user'] = _.cloneDeep(stubs.genericModel);
    values = {"actualChildBirth":"2014-05-28","address":"Immaculateness internalize","cellPhone":"Revolting Giauque","city":"Hamburgers philatelic","clinicianCodeId":69437,"clinicName":"Drilling sterilizer","consentAcceptedOn":"1983-01-10 23:29:57 +0000","contactCellPhone":"Oscillators Bayesian","contactEmail":"Newsreels obstructionists","contactHomePhone":"Cedes heard","contactName":"Hitherto obtruding","deactivatedOn":"1999-10-14 14:50:11 +0000","educationId":27907,"email":"orville.veum63@vaccinesurvey.com","expectedChildBirth":"2015-03-23","firstName":"Rod","hasContactUsers":false,"homePhone":"Whigs inadequacies","interventionGroup":"Retails ideologists","isDeactive":true,"lastName":"Wiegand","parentRelationshipType":"Climactic unseated","parentUserId":65075,"password":"password","passwordConfirmation":"password","passwordDigest":"Diphthong authenticated","patientType":65827,"postalCode":"Superber facetiousness","raceId":62188,"reasonForDeactivation":"Pilaus forgathers","resetPassword":false,"role":"Forcing Bridger","state":"Overtaxing outcry","updatedUserProfile":true,"vaccinationReminders":true,"xSessionId":"Complexities pitted"};
    
    defaultAuthDigest = function(values) {};
  ...
  describe('create', function() {
    ...
    it('should execute authPasswordDigest function', function() {
      var authDigest = function(values) {
        assert(values);
        controller.__set__('authPasswordDigest', defaultAuthDigest);
      };

      controller.__set__('authPasswordDigest', authDigest);
