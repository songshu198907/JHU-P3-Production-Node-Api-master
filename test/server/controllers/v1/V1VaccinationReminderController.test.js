var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1VaccinationReminderController'),
...
describe('V1VaccinationReminder Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1vaccinationreminder'] = _.cloneDeep(stubs.genericModel);
    values = {"messageText":"Electromagnet recessionals","triggerDaysFromDob":44637};
