var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1ClinicianCodeController'),
...
describe('V1ClinicianCode Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1cliniciancode'] = _.cloneDeep(stubs.genericModel);
    values = {"code":"Restudies particularizes","name":"Milo Bogan"};
