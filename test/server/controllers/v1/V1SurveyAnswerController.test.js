var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SurveyAnswerController'),
...
describe('V1SurveyAnswer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1surveyanswer'] = _.cloneDeep(stubs.genericModel);
    values = {"allowFreeForm":true,"freeFormDataType":"Godfathers geopolitical","label":"Bigot insularity","sortOrder":98610,"surveyQuestionId":9164,"videoTargetNumber":16767,"weight":73611};
