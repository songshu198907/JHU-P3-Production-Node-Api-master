var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1HealthcareProviderContentController'),
...
describe('V1HealthcareProviderContent Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1healthcareprovidercontent'] = _.cloneDeep(stubs.genericModel);
    values = {"categoryGroup":"Preservation halls","desc":"Sculptures inanimate","externalLink":"Albania bilked","keywords":"Overexposure icily","title":"Cannibalized goody","topicId":44294};
