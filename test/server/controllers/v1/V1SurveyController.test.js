var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1SurveyController'),
...
describe('V1Survey Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1survey'] = _.cloneDeep(stubs.genericModel);
    values = {"interventionGroup":"Reconstructing harmlessness","isActive":true,"name":"Rex Miller","patientType":64699,"surveyType":"Shaming melanges","totalQuestions":15666,"version":22237};
