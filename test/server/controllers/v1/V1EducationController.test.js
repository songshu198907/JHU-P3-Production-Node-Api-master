var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1EducationController'),
...
describe('V1Education Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1education'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Colleen Bergnaum"};
