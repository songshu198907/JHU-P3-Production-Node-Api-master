var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2HealthcareProviderContentController'),
...
describe('V2HealthcareProviderContent Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2healthcareprovidercontent'] = _.cloneDeep(stubs.genericModel);
    values = {"categoryGroup":"Capillaries rides","desc":"Smocks hairpieces","externalLink":"Muskogee crosswalk","keywords":"Uniformity muckiest","title":"Billowiest representations","topicId":96837};
