var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2QuestionCodeController'),
...
describe('V2QuestionCode Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2questioncode'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Wilbert Effertz"};
