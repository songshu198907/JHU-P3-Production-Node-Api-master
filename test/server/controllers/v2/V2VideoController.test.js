var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2VideoController'),
...
describe('V2Video Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2video'] = _.cloneDeep(stubs.genericModel);
    values = {"desc":"Aspects unhinges","isActive":false,"keywords":"Unbarring pooch","length":67533.44330626441,"questionGroup":"Overdrafts ignoramuses","sortOrder":92175,"sourceVersion":"Capriciousness disadvantageous","targetNumber":2592,"title":"Piggyback information","topicId":69436,"videoUrl":"Fledglings procrastinates"};
