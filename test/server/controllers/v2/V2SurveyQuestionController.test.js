var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SurveyQuestionController'),
...
describe('V2SurveyQuestion Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2surveyquestion'] = _.cloneDeep(stubs.genericModel);
    values = {"didYouKnowText":"Obsolescent domineer","label":"Interrogatories chronologically","questionCategoryId":1333,"questionCodeId":80206,"questionGroup":"Conspiratorial peritoneums","questionText":"Delaying counterclaiming","questionTypeId":33042,"requiredAnswer":true,"sortOrder":21587,"surveyId":18083};
