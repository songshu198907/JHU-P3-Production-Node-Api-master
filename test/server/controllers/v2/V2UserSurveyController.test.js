var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2UserSurveyController'),
...
describe('V2UserSurvey Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2usersurvey'] = _.cloneDeep(stubs.genericModel);
    values = {"completedAt":"Unhesitatingly accomplishment","completition":56840,"createdAt":"1986-06-01 05:15:47 +0000","currentuseranswers":[1,2,3],"firstQuestion":{"one":1,"two":2,"three":3},"firstQuestionId":72186,"firstReminder":false,"isComplete":true,"matchedVideos":[1,2,3],"maternalVideoComplete":true,"maternalVideoNumber":"Concords federalism","maternalVideoPosition":23209.633090685886,"pediatricVideoComplete":false,"pediatricVideoNumber":"Annotate transliterated","pediatricVideoPosition":64101.79723019386,"questionCount":21264,"secondReminder":false,"surveyId":51350,"userId":58398,"videoSourceVersion":"Lullabies glamouring"};
