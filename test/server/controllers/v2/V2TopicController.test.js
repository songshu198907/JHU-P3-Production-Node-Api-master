var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2TopicController'),
...
describe('V2Topic Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2topic'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Kalyn Ullrich"};
