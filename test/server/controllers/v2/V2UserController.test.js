var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2UserController'),
...
describe('V2User Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2user'] = _.cloneDeep(stubs.genericModel);
    values = {"actualChildBirth":"2014-08-12","address":"Mamma dextrose","cellPhone":"Stork disapprovingly","city":"Southwards cobbling","clinicianCodeId":90890,"clinicName":"Hibachis inseparability","consentAcceptedOn":"1970-01-05 01:25:54 +0000","contactCellPhone":"Baseboards fagots","contactEmail":"Reactionary steers","contactHomePhone":"Electioneering selects","contactName":"Azores advantageously","deactivatedOn":"1994-10-29 14:40:35 +0000","educationId":55477,"email":"wilma.beier61@vaccinesurvey.com","expectedChildBirth":"2016-10-29","firstName":"Venessa","hasContactUsers":false,"homePhone":"Reinforcements rapidity","interventionGroup":"Nonprofessional parenthetically","isDeactive":false,"lastName":"Keeling","parentRelationshipType":"Glaring roosting","parentUserId":48125,"password":"password","passwordConfirmation":"password","passwordDigest":"Cyclamens rendezvousing","patientType":69764,"postalCode":"Firefights Georgian","raceId":59565,"reasonForDeactivation":"Mocha belles","resetPassword":true,"role":"Imperceptibly Nigel","state":"Maidens disadvantageous","updatedUserProfile":true,"vaccinationReminders":false,"xSessionId":"Vanquishing interference"};
