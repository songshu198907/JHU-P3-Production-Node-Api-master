var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2EducationController'),
...
describe('V2Education Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2education'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Jeraldine Pacocha"};
