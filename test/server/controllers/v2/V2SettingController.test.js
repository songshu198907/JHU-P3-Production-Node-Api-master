var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SettingController'),
...
describe('V2Setting Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2setting'] = _.cloneDeep(stubs.genericModel);
    values = {"awsHealthcareContentBucketName":"Hypocritically incompatibility","awsVideoBucketName":"Irkutsk dismayed","contactUserRegistrationEmailText":"Bergs descends","contactUserRegistrationSubject":"Storyteller canister","forgotPasswordEmailText":"Cliffhangers ricochets","forgotPasswordSubject":"Suite Fridays","fromEmail":"Georgette reorganizations","smsPhoneNumber":"Afghanistan kneeing","surveyCompletionEmailSubject":"Slots skinflint","surveyCompletionEmailText":"Trustworthiness gallantry","surveyNotificationEmailText":"Intimidating hightail","surveyNotificationFinalSmsText":"Bates bohemian","surveyNotificationFirstReminderEmailText":"Interchangeably secretion","surveyNotificationFirstReminderSubject":"Antiparticles manipulations","surveyNotificationSubject":"Recuperated slaughterhouse","termsAndConditions":"Okays randomness"};
