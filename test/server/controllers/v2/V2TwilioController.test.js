var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2TwilioController'),
...
describe('V2Twilio Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2twilio'] = _.cloneDeep(stubs.genericModel);
    values = {"id":31461};
