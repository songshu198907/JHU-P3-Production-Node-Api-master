var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SearchAuditLoggingController'),
...
describe('V2SearchAuditLogging Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2searchauditlogging'] = _.cloneDeep(stubs.genericModel);
    values = {"createdAt":"2013-01-07 23:08:56 +0000","searchTerm":"Comprehensions jibes","userId":90054};
