var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2UserSurveyVideoController'),
...
describe('V2UserSurveyVideo Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2usersurveyvideo'] = _.cloneDeep(stubs.genericModel);
    values = {"isComplete":true,"sortOrder":48092,"userSurveyId":55508,"videoNumber":90494,"videoPosition":59966.54960270482,"videoSourceVersion":"Smartest jelled","videoType":"Resourcefulness diagonals"};
