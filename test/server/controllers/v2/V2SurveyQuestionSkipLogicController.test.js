var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SurveyQuestionSkipLogicController'),
...
describe('V2SurveyQuestionSkipLogic Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2surveyquestionskiplogic'] = _.cloneDeep(stubs.genericModel);
    values = {"skipQuestionCodes":"Mombasa tolerates","surveyAnswerId":"Dugout lyricists"};
