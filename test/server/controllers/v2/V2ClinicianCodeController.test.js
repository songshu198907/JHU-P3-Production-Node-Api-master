var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2ClinicianCodeController'),
...
describe('V2ClinicianCode Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2cliniciancode'] = _.cloneDeep(stubs.genericModel);
    values = {"code":"Tristan whammies","name":"Eli Feil"};
