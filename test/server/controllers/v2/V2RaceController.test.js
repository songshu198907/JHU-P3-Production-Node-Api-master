var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2RaceController'),
...
describe('V2Race Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2race'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Isaias Mante"};
