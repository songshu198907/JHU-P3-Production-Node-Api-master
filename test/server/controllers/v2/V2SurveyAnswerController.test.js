var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SurveyAnswerController'),
...
describe('V2SurveyAnswer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2surveyanswer'] = _.cloneDeep(stubs.genericModel);
    values = {"allowFreeForm":false,"freeFormDataType":"Knockouts Lipizzaner","label":"Fools Stein","sortOrder":99600,"surveyQuestionId":76948,"videoTargetNumber":50260,"weight":34801};
