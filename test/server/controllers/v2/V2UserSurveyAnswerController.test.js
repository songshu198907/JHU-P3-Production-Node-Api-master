var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2UserSurveyAnswerController'),
...
describe('V2UserSurveyAnswer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2usersurveyanswer'] = _.cloneDeep(stubs.genericModel);
    values = {"appliedSkipLogicId":78491,"freeFormResponse":"Unmatched adolescences","nextquestion":{"one":1,"two":2,"three":3},"previousquestion":{"one":1,"two":2,"three":3},"questionCodeId":29767,"questionGroup":"Reliability sheets","questionOrder":19885,"skipped":true,"surveyAnswerId":3985,"surveyQuestionId":44466,"userSurveyId":1010};
