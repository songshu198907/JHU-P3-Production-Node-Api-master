var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2VaccinationReminderController'),
...
describe('V2VaccinationReminder Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2vaccinationreminder'] = _.cloneDeep(stubs.genericModel);
    values = {"messageText":"Misconstruction mathematically","triggerDaysFromDob":91606};
