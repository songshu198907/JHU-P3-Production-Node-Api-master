var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2QuestionCategoryController'),
...
describe('V2QuestionCategory Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2questioncategory'] = _.cloneDeep(stubs.genericModel);
    values = {"name":"Elayne Williamson"};
