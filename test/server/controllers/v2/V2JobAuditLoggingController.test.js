var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2JobAuditLoggingController'),
...
describe('V2JobAuditLogging Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2jobauditlogging'] = _.cloneDeep(stubs.genericModel);
    values = {"createdAt":"1976-11-21 22:43:25 +0000","name":"Santos Macejkovic","rowsEffected":"Undergraduates fixative"};
