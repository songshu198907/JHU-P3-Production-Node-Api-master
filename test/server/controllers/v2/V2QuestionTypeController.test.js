var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2QuestionTypeController'),
...
describe('V2QuestionType Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2questiontype'] = _.cloneDeep(stubs.genericModel);
    values = {"controlType":"Reassessments comported","name":"Fe Bogan"};
