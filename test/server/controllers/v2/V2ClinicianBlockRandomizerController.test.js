var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2ClinicianBlockRandomizerController'),
...
describe('V2ClinicianBlockRandomizer Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2clinicianblockrandomizer'] = _.cloneDeep(stubs.genericModel);
    values = {"id":82845,"clinicianCodeId":94351,"interventionGroup":"Roman borsch","patientType":"Privatized cesium"};
