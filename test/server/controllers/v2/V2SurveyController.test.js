var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2SurveyController'),
...
describe('V2Survey Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2survey'] = _.cloneDeep(stubs.genericModel);
    values = {"interventionGroup":"Transnationals Mfume","isActive":true,"name":"Sylvia Gleason","patientType":61228,"surveyType":"Antoine tenuous","totalQuestions":50589,"version":16205};
