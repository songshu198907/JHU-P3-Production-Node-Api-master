var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V2VideoAuditLoggingController'),
...
describe('V2VideoAuditLogging Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v2videoauditlogging'] = _.cloneDeep(stubs.genericModel);
    values = {"createdAt":"1983-05-16 18:17:44 +0000","duration":49604.233345786364,"userId":81048,"videoId":31356,"watchedEntireVideo":false};
