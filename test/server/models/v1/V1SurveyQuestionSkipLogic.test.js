...
describe('V1SurveyQuestionSkipLogic Model', function() {

  afterEach(function() {
    V1SurveyQuestionSkipLogic.destroy();
  });
  ...
  it('should successfully create an instance of V1SurveyQuestionSkipLogic', function(done) {
    var beforeCount;

    V1SurveyQuestionSkipLogic.count()
      .then(function(count) {
        beforeCount = count;
        return V1SurveyQuestionSkipLogic.create({"skipQuestionCodes":"Unconsciousness ineffectiveness","surveyAnswerId":"Practises pharmaceutical"});
      })
      .then(function(obj) {
  ...
  it('should successfully read an instance of V1SurveyQuestionSkipLogic', function(done) {

    var attributes = {"skipQuestionCodes":"Mudslingers abrogated","surveyAnswerId":"Reconciles avocation"};
    var id;

    if (attributes && Object.keys(attributes).length !== 0) {
      V1SurveyQuestionSkipLogic.findOne(attributes)
        .then(function(record) {
          assert(!record, 'Should not have found a record.');
          return V1SurveyQuestionSkipLogic.create(attributes);
        })
        .then(function(obj) {
          assert(obj, 'Failed to create object.');
          id = obj.id;
          return V1SurveyQuestionSkipLogic.findOne({'id':obj.id});
        })
        .then(function(obj) {
  ...
  it('should successfully update an instance of V1SurveyQuestionSkipLogic', function(done) {
    var attributes = {"skipQuestionCodes":"Connectors granddaughter","surveyAnswerId":"Bulge trajectories"};
    var updatedObject;

    V1SurveyQuestionSkipLogic.create(attributes)
      .then(function(obj) {
        assert(obj, 'Failed to create object.');
        var attributes = {"skipQuestionCodes":"Schematics instructional","surveyAnswerId":"Interpose briers"};
        return V1SurveyQuestionSkipLogic.update(obj.id, attributes);
      })
      .then(function(collection) {
        updatedObject = collection[0];
        assert(updatedObject, 'Failed to update object.');
        return V1SurveyQuestionSkipLogic.findOne({'id':updatedObject.id});
      })
      .then(function(obj) {
  ...
  it('should successfully destroy an instance of V1SurveyQuestionSkipLogic', function(done) {

    var attributes = {"skipQuestionCodes":"Uncontroversial acceptability","surveyAnswerId":"Industrializing anthologizes"};
    ...
    if (attributes && Object.keys(attributes).length !== 0) {
      V1SurveyQuestionSkipLogic.findOne(attributes)
        ...
        .then(function(obj) {
          assert(obj, 'Failed to create object.');
          return V1SurveyQuestionSkipLogic.destroy(obj.id);
        })
        .then(function(collection) {
  ...
  describe('custom callbacks', function() {
    it('should have a callbacks object', function() {
      assert(V1SurveyQuestionSkipLogic.callbacks, 'V1SurveyQuestionSkipLogic is missing the callbacks object');
    });
      ...
      it('should contain "beforeCreate" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['beforeCreate'], 'beforeCreate is missing.');
      });

      it('"beforeCreate" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['beforeCreate']), 'beforeCreate should be a function.');
    });
    
      

      it('should contain "afterCreate" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['afterCreate'], 'afterCreate is missing.');
      });

      it('"afterCreate" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['afterCreate']), 'afterCreate should be a function.');
    });
    
      

      it('should contain "beforeFind" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['beforeFind'], 'beforeFind is missing.');
      });

      it('"beforeFind" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['beforeFind']), 'beforeFind should be a function.');
    });
    
      

      it('should contain "afterFind" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['afterFind'], 'afterFind is missing.');
      });

      it('"afterFind" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['afterFind']), 'afterFind should be a function.');
    });
    
      

      it('should contain "beforeUpdate" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['beforeUpdate'], 'beforeUpdate is missing.');
      });

      it('"beforeUpdate" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['beforeUpdate']), 'beforeUpdate should be a function.');
    });
    
      

      it('should contain "afterUpdate" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['afterUpdate'], 'afterUpdate is missing.');
      });

      it('"afterUpdate" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['afterUpdate']), 'afterUpdate should be a function.');
    });
    
      

      it('should contain "beforeDestroy" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['beforeDestroy'], 'beforeDestroy is missing.');
      });

      it('"beforeDestroy" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['beforeDestroy']), 'beforeDestroy should be a function.');
    });
    
      

      it('should contain "afterDestroy" callback', function() {
        assert(V1SurveyQuestionSkipLogic.callbacks['afterDestroy'], 'afterDestroy is missing.');
      });

      it('"afterDestroy" callback should be a function', function() {
      assert(_.isFunction(V1SurveyQuestionSkipLogic.callbacks['afterDestroy']), 'afterDestroy should be a function.');
    });
