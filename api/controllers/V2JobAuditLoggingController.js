...
var extensions          = require('./custom/v2/jobAuditLoggingCustom'),
    callbacks           = require('./custom/v2/jobAuditLoggingCallbacks'),
...
var V2JobAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2JobAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2jobauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2JobAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2JobAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2JobAuditLoggingController.create");
...
if(extensions) {
  extend(V2JobAuditLoggingController, 'V2JobAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2JobAuditLoggingController, 'V2JobAuditLoggingController', callbacks, 'callbacks');
}
