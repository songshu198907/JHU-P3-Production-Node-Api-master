...
var V1ClinicianBlockRandomizerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1ClinicianBlockRandomizerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1clinicianblockrandomizer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1ClinicianBlockRandomizerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1ClinicianBlockRandomizerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1ClinicianBlockRandomizerController.create");
...
if(extensions) {
  extend(V1ClinicianBlockRandomizerController, 'V1ClinicianBlockRandomizerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1ClinicianBlockRandomizerController, 'V1ClinicianBlockRandomizerController', callbacks, 'callbacks');
}
