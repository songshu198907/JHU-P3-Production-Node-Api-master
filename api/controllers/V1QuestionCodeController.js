...
var V1QuestionCodeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1QuestionCodeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1questioncode'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1QuestionCodeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1QuestionCodeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1QuestionCodeController.create");
...
if(extensions) {
  extend(V1QuestionCodeController, 'V1QuestionCodeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1QuestionCodeController, 'V1QuestionCodeController', callbacks, 'callbacks');
}
