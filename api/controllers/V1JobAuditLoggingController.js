...
var V1JobAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1JobAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1jobauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1JobAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1JobAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1JobAuditLoggingController.create");
...
if(extensions) {
  extend(V1JobAuditLoggingController, 'V1JobAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1JobAuditLoggingController, 'V1JobAuditLoggingController', callbacks, 'callbacks');
}
