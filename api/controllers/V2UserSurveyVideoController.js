...
var V2UserSurveyVideoController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2UserSurveyVideoController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2usersurveyvideo'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2UserSurveyVideoController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2UserSurveyVideoController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2UserSurveyVideoController.create");
...
if(extensions) {
  extend(V2UserSurveyVideoController, 'V2UserSurveyVideoController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2UserSurveyVideoController, 'V2UserSurveyVideoController', callbacks, 'callbacks');
}
