...
var V2VideoController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2VideoController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2video'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2VideoController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2VideoController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2VideoController.create");
...
if(extensions) {
  extend(V2VideoController, 'V2VideoController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2VideoController, 'V2VideoController', callbacks, 'callbacks');
}
