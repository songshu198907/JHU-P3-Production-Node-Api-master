...
var V2SendGridController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SendGridController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2sendgrid'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SendGridController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SendGridController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SendGridController.create");
...
if(extensions) {
  extend(V2SendGridController, 'V2SendGridController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SendGridController, 'V2SendGridController', callbacks, 'callbacks');
}
