...
var V2UserAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2UserAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2userauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2UserAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2UserAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2UserAuditLoggingController.create");
...
if(extensions) {
  extend(V2UserAuditLoggingController, 'V2UserAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2UserAuditLoggingController, 'V2UserAuditLoggingController', callbacks, 'callbacks');
}
