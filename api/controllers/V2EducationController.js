...
var V2EducationController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2EducationController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2education'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2EducationController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2EducationController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2EducationController.create");
...
if(extensions) {
  extend(V2EducationController, 'V2EducationController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2EducationController, 'V2EducationController', callbacks, 'callbacks');
}
