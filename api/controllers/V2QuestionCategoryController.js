...
var V2QuestionCategoryController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2QuestionCategoryController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2questioncategory'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2QuestionCategoryController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2QuestionCategoryController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2QuestionCategoryController.create");
...
if(extensions) {
  extend(V2QuestionCategoryController, 'V2QuestionCategoryController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2QuestionCategoryController, 'V2QuestionCategoryController', callbacks, 'callbacks');
}
