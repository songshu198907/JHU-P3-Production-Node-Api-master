...
var V2TwilioController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2TwilioController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2twilio'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2TwilioController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2TwilioController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2TwilioController.create");
...
if(extensions) {
  extend(V2TwilioController, 'V2TwilioController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2TwilioController, 'V2TwilioController', callbacks, 'callbacks');
}
