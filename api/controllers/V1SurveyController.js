...
var V1SurveyController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SurveyController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1survey'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SurveyController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SurveyController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SurveyController.create");
...
if(extensions) {
  extend(V1SurveyController, 'V1SurveyController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SurveyController, 'V1SurveyController', callbacks, 'callbacks');
}
