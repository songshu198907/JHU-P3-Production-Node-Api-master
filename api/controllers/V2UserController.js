...
var V2UserController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2UserController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2user'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2UserController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2UserController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2UserController.create");
...
if(extensions) {
  extend(V2UserController, 'V2UserController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2UserController, 'V2UserController', callbacks, 'callbacks');
}
