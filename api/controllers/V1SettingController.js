...
var extensions          = require('./custom/v1/settingCustom'),
    callbacks           = require('./custom/v1/settingCallbacks'),
...
var V1SettingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SettingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1setting'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SettingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SettingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SettingController.create");
...
if(extensions) {
  extend(V1SettingController, 'V1SettingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SettingController, 'V1SettingController', callbacks, 'callbacks');
}
