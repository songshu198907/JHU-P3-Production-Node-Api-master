...
var V2SurveyQuestionSkipLogicController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SurveyQuestionSkipLogicController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2surveyquestionskiplogic'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SurveyQuestionSkipLogicController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SurveyQuestionSkipLogicController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SurveyQuestionSkipLogicController.create");
...
if(extensions) {
  extend(V2SurveyQuestionSkipLogicController, 'V2SurveyQuestionSkipLogicController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SurveyQuestionSkipLogicController, 'V2SurveyQuestionSkipLogicController', callbacks, 'callbacks');
}
