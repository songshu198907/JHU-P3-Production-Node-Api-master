...
var extensions          = require('./custom/v2/clinicianBlockRandomizerCustom'),
    callbacks           = require('./custom/v2/clinicianBlockRandomizerCallbacks'),
...
var V2ClinicianBlockRandomizerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2ClinicianBlockRandomizerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2clinicianblockrandomizer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2ClinicianBlockRandomizerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2ClinicianBlockRandomizerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2ClinicianBlockRandomizerController.create");
...
if(extensions) {
  extend(V2ClinicianBlockRandomizerController, 'V2ClinicianBlockRandomizerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2ClinicianBlockRandomizerController, 'V2ClinicianBlockRandomizerController', callbacks, 'callbacks');
}
