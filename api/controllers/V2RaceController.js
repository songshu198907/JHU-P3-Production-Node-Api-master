...
var extensions          = require('./custom/v2/raceCustom'),
    callbacks           = require('./custom/v2/raceCallbacks'),
...
var V2RaceController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2RaceController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2race'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2RaceController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2RaceController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2RaceController.create");
...
if(extensions) {
  extend(V2RaceController, 'V2RaceController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2RaceController, 'V2RaceController', callbacks, 'callbacks');
}
