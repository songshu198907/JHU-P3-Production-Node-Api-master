...
var V1SurveyQuestionController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SurveyQuestionController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1surveyquestion'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SurveyQuestionController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SurveyQuestionController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SurveyQuestionController.create");
...
if(extensions) {
  extend(V1SurveyQuestionController, 'V1SurveyQuestionController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SurveyQuestionController, 'V1SurveyQuestionController', callbacks, 'callbacks');
}
