...
var extensions          = require('./custom/v1/raceCustom'),
    callbacks           = require('./custom/v1/raceCallbacks'),
...
var V1RaceController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1RaceController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1race'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1RaceController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1RaceController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1RaceController.create");
...
if(extensions) {
  extend(V1RaceController, 'V1RaceController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1RaceController, 'V1RaceController', callbacks, 'callbacks');
}
