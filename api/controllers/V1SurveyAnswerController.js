...
var V1SurveyAnswerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SurveyAnswerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1surveyanswer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SurveyAnswerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SurveyAnswerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SurveyAnswerController.create");
...
if(extensions) {
  extend(V1SurveyAnswerController, 'V1SurveyAnswerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SurveyAnswerController, 'V1SurveyAnswerController', callbacks, 'callbacks');
}
