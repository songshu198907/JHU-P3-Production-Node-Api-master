...
var extensions          = require('./custom/v1/searchAuditLoggingCustom'),
    callbacks           = require('./custom/v1/searchAuditLoggingCallbacks'),
...
var V1SearchAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SearchAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1searchauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SearchAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SearchAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SearchAuditLoggingController.create");
...
if(extensions) {
  extend(V1SearchAuditLoggingController, 'V1SearchAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SearchAuditLoggingController, 'V1SearchAuditLoggingController', callbacks, 'callbacks');
}
