...
var V2SearchAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SearchAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2searchauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SearchAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SearchAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SearchAuditLoggingController.create");
...
if(extensions) {
  extend(V2SearchAuditLoggingController, 'V2SearchAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SearchAuditLoggingController, 'V2SearchAuditLoggingController', callbacks, 'callbacks');
}
