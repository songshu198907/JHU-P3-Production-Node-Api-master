...
var extensions          = require('./custom/v2/healthcareProviderContentCustom'),
    ...
    DataProxy           = require('../libs/data-proxies/standardDataProxy'),
...
var V2HealthcareProviderContentController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2HealthcareProviderContentController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2healthcareprovidercontent'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2HealthcareProviderContentController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2HealthcareProviderContentController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2HealthcareProviderContentController.create");
...
if(extensions) {
  extend(V2HealthcareProviderContentController, 'V2HealthcareProviderContentController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2HealthcareProviderContentController, 'V2HealthcareProviderContentController', callbacks, 'callbacks');
}
