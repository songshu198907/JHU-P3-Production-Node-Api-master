...
var V1HealthcareProviderContentController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1HealthcareProviderContentController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1healthcareprovidercontent'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1HealthcareProviderContentController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1HealthcareProviderContentController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1HealthcareProviderContentController.create");
...
if(extensions) {
  extend(V1HealthcareProviderContentController, 'V1HealthcareProviderContentController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1HealthcareProviderContentController, 'V1HealthcareProviderContentController', callbacks, 'callbacks');
}
