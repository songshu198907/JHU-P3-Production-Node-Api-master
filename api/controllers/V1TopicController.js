...
var V1TopicController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1TopicController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1topic'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1TopicController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1TopicController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1TopicController.create");
...
if(extensions) {
  extend(V1TopicController, 'V1TopicController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1TopicController, 'V1TopicController', callbacks, 'callbacks');
}
