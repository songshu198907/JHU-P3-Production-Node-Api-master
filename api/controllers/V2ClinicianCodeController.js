...
var extensions          = require('./custom/v2/clinicianCodeCustom'),
    callbacks           = require('./custom/v2/clinicianCodeCallbacks'),
...
var V2ClinicianCodeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2ClinicianCodeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2cliniciancode'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2ClinicianCodeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2ClinicianCodeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2ClinicianCodeController.create");
...
if(extensions) {
  extend(V2ClinicianCodeController, 'V2ClinicianCodeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2ClinicianCodeController, 'V2ClinicianCodeController', callbacks, 'callbacks');
}
