...
var V2TopicController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2TopicController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2topic'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2TopicController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2TopicController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2TopicController.create");
...
if(extensions) {
  extend(V2TopicController, 'V2TopicController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2TopicController, 'V2TopicController', callbacks, 'callbacks');
}
