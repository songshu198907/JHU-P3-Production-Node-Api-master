...
var V1EducationController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1EducationController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1education'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1EducationController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1EducationController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1EducationController.create");
...
if(extensions) {
  extend(V1EducationController, 'V1EducationController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1EducationController, 'V1EducationController', callbacks, 'callbacks');
}
