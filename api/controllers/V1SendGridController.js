...
var V1SendGridController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SendGridController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1sendgrid'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SendGridController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SendGridController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SendGridController.create");
...
if(extensions) {
  extend(V1SendGridController, 'V1SendGridController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SendGridController, 'V1SendGridController', callbacks, 'callbacks');
}
