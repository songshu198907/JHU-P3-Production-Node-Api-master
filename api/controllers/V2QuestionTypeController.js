...
var V2QuestionTypeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2QuestionTypeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2questiontype'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2QuestionTypeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2QuestionTypeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2QuestionTypeController.create");
...
if(extensions) {
  extend(V2QuestionTypeController, 'V2QuestionTypeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2QuestionTypeController, 'V2QuestionTypeController', callbacks, 'callbacks');
}
