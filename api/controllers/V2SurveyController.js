...
var V2SurveyController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SurveyController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2survey'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SurveyController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SurveyController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SurveyController.create");
...
if(extensions) {
  extend(V2SurveyController, 'V2SurveyController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SurveyController, 'V2SurveyController', callbacks, 'callbacks');
}
