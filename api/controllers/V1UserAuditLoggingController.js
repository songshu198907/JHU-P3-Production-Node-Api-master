...
var V1UserAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1UserAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1userauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1UserAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1UserAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1UserAuditLoggingController.create");
...
if(extensions) {
  extend(V1UserAuditLoggingController, 'V1UserAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1UserAuditLoggingController, 'V1UserAuditLoggingController', callbacks, 'callbacks');
}
