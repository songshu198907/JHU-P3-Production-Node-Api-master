...
var V1QuestionCategoryController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1QuestionCategoryController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1questioncategory'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1QuestionCategoryController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1QuestionCategoryController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1QuestionCategoryController.create");
...
if(extensions) {
  extend(V1QuestionCategoryController, 'V1QuestionCategoryController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1QuestionCategoryController, 'V1QuestionCategoryController', callbacks, 'callbacks');
}
