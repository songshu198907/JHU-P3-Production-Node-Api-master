...
var V1UserSurveyAnswerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1UserSurveyAnswerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1usersurveyanswer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1UserSurveyAnswerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1UserSurveyAnswerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1UserSurveyAnswerController.create");
...
if(extensions) {
  extend(V1UserSurveyAnswerController, 'V1UserSurveyAnswerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1UserSurveyAnswerController, 'V1UserSurveyAnswerController', callbacks, 'callbacks');
}
