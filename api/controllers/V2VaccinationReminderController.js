...
var V2VaccinationReminderController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2VaccinationReminderController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2vaccinationreminder'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2VaccinationReminderController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2VaccinationReminderController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2VaccinationReminderController.create");
...
if(extensions) {
  extend(V2VaccinationReminderController, 'V2VaccinationReminderController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2VaccinationReminderController, 'V2VaccinationReminderController', callbacks, 'callbacks');
}
