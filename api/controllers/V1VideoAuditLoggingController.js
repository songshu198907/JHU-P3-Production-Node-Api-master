...
var extensions          = require('./custom/v1/videoAuditLoggingCustom'),
    callbacks           = require('./custom/v1/videoAuditLoggingCallbacks'),
...
var V1VideoAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1VideoAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1videoauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1VideoAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1VideoAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1VideoAuditLoggingController.create");
...
if(extensions) {
  extend(V1VideoAuditLoggingController, 'V1VideoAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1VideoAuditLoggingController, 'V1VideoAuditLoggingController', callbacks, 'callbacks');
}
