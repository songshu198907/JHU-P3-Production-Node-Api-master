...
var V2VideoAuditLoggingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2VideoAuditLoggingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2videoauditlogging'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2VideoAuditLoggingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2VideoAuditLoggingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2VideoAuditLoggingController.create");
...
if(extensions) {
  extend(V2VideoAuditLoggingController, 'V2VideoAuditLoggingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2VideoAuditLoggingController, 'V2VideoAuditLoggingController', callbacks, 'callbacks');
}
