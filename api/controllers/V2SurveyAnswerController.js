...
var V2SurveyAnswerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SurveyAnswerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2surveyanswer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SurveyAnswerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SurveyAnswerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SurveyAnswerController.create");
...
if(extensions) {
  extend(V2SurveyAnswerController, 'V2SurveyAnswerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SurveyAnswerController, 'V2SurveyAnswerController', callbacks, 'callbacks');
}
