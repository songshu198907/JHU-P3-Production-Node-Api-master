...
var V2UserSurveyController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2UserSurveyController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2usersurvey'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2UserSurveyController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2UserSurveyController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2UserSurveyController.create");
...
if(extensions) {
  extend(V2UserSurveyController, 'V2UserSurveyController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2UserSurveyController, 'V2UserSurveyController', callbacks, 'callbacks');
}
