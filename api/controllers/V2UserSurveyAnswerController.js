...
var V2UserSurveyAnswerController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2UserSurveyAnswerController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2usersurveyanswer'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2UserSurveyAnswerController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2UserSurveyAnswerController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2UserSurveyAnswerController.create");
...
if(extensions) {
  extend(V2UserSurveyAnswerController, 'V2UserSurveyAnswerController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2UserSurveyAnswerController, 'V2UserSurveyAnswerController', callbacks, 'callbacks');
}
