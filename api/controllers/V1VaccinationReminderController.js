...
var extensions          = require('./custom/v1/vaccinationReminderCustom'),
    callbacks           = require('./custom/v1/vaccinationReminderCallbacks'),
...
var V1VaccinationReminderController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1VaccinationReminderController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1vaccinationreminder'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1VaccinationReminderController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1VaccinationReminderController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1VaccinationReminderController.create");
...
if(extensions) {
  extend(V1VaccinationReminderController, 'V1VaccinationReminderController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1VaccinationReminderController, 'V1VaccinationReminderController', callbacks, 'callbacks');
}
