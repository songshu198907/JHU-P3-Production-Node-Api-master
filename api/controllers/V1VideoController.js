...
var extensions          = require('./custom/v1/videoCustom'),
    callbacks           = require('./custom/v1/videoCallbacks'),
...
var V1VideoController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1VideoController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1video'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1VideoController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1VideoController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1VideoController.create");
...
if(extensions) {
  extend(V1VideoController, 'V1VideoController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1VideoController, 'V1VideoController', callbacks, 'callbacks');
}
