...
var authPasswordDigest  = require('../libs/authPasswordDigest');

var V1UserController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1UserController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1user'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1UserController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1UserController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1UserController.create");
...
if(extensions) {
  extend(V1UserController, 'V1UserController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1UserController, 'V1UserController', callbacks, 'callbacks');
}
