...
var V2SurveyQuestionController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SurveyQuestionController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2surveyquestion'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SurveyQuestionController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SurveyQuestionController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SurveyQuestionController.create");
...
if(extensions) {
  extend(V2SurveyQuestionController, 'V2SurveyQuestionController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SurveyQuestionController, 'V2SurveyQuestionController', callbacks, 'callbacks');
}
