module.exports = {
  ...
  beforeGetQuestionBySurveyScope: function(req, done) {
    
done();

  },

  afterGetQuestionBySurveyScope: function(req, res, done) {
    
done();

  },

  beforeDeleteSurveyQuestionScope: function(req, done) {
    
done();

  },

  afterDeleteSurveyQuestionScope: function(req, res, done) {
