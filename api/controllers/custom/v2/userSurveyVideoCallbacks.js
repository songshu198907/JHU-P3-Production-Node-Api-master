module.exports = {
  ...
  beforeGetVideosForUserSurveyIdScope: function(req, done) {
    
done();

  },

  afterGetVideosForUserSurveyIdScope: function(req, res, done) {
    
done();

  },

  beforeGetVideoByIdScope: function(req, done) {
    
done();

  },

  afterGetVideoByIdScope: function(req, res, done) {
