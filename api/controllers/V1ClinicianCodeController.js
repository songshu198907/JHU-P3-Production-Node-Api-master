...
var extensions          = require('./custom/v1/clinicianCodeCustom'),
    callbacks           = require('./custom/v1/clinicianCodeCallbacks'),
...
var V1ClinicianCodeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1ClinicianCodeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1cliniciancode'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1ClinicianCodeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1ClinicianCodeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1ClinicianCodeController.create");
...
if(extensions) {
  extend(V1ClinicianCodeController, 'V1ClinicianCodeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1ClinicianCodeController, 'V1ClinicianCodeController', callbacks, 'callbacks');
}
