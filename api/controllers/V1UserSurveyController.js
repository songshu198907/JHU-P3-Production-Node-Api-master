...
var V1UserSurveyController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1UserSurveyController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1usersurvey'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1UserSurveyController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1UserSurveyController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1UserSurveyController.create");
...
if(extensions) {
  extend(V1UserSurveyController, 'V1UserSurveyController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1UserSurveyController, 'V1UserSurveyController', callbacks, 'callbacks');
}
