...
var V1SurveyQuestionSkipLogicController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1SurveyQuestionSkipLogicController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1surveyquestionskiplogic'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1SurveyQuestionSkipLogicController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1SurveyQuestionSkipLogicController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1SurveyQuestionSkipLogicController.create");
...
if(extensions) {
  extend(V1SurveyQuestionSkipLogicController, 'V1SurveyQuestionSkipLogicController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1SurveyQuestionSkipLogicController, 'V1SurveyQuestionSkipLogicController', callbacks, 'callbacks');
}
