...
var V2QuestionCodeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2QuestionCodeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2questioncode'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2QuestionCodeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2QuestionCodeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2QuestionCodeController.create");
...
if(extensions) {
  extend(V2QuestionCodeController, 'V2QuestionCodeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2QuestionCodeController, 'V2QuestionCodeController', callbacks, 'callbacks');
}
