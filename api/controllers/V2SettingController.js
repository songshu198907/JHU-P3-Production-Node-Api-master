...
var V2SettingController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V2SettingController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v2setting'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V2SettingController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V2SettingController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V2SettingController.create");
...
if(extensions) {
  extend(V2SettingController, 'V2SettingController', extensions, 'customCode');
}

if (callbacks) {
  extend(V2SettingController, 'V2SettingController', callbacks, 'callbacks');
}
