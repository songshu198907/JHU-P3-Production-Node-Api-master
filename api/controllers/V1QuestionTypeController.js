...
var V1QuestionTypeController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1QuestionTypeController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1questiontype'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1QuestionTypeController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1QuestionTypeController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1QuestionTypeController.create");
...
if(extensions) {
  extend(V1QuestionTypeController, 'V1QuestionTypeController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1QuestionTypeController, 'V1QuestionTypeController', callbacks, 'callbacks');
}
