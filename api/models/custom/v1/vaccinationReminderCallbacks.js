module.exports = {
  ...
  beforeSortedByTriggerDaysScope: function(values, req, done) {
    
 done();

  },

  afterSortedByTriggerDaysScope: function(models, req, done) {
    
done();

  },

  beforeSendVaccinationRemindersScope: function(values, req, done) {
    
 done();

  },

  afterSendVaccinationRemindersScope: function(models, req, done) {
